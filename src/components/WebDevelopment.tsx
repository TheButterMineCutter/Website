...
export const WebDevelopment = () => {
  ...
  return (
    <div id="main" className='w-screen h-screen bg-slate-900'>
      <div className='w-screen h-[30vh] flex justify-center items-center'>
        <h1 ref={titleRef} className='text-white text-5xl font-medium opacity-0'>Web Development</h1>
      </div>
      <div className='flex w-screen h-[70vh]'>
        ...
        <div className='w-[40vw] h-[70vh] border-l-2 border-opacity-20 pl-5 border-white '>
          <h1 ref={textOneRef} className='w-[100%] h-[30%] text-3xl text-white mt-[10px] opacity-0'>Developing the<br></br>Frontend and Backend<br></br> for the Web</h1>
